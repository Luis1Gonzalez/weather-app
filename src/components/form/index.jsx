        ...
        <div className='container row d-flex'>
            <form onSubmit = {onSubmit}>
                <div className='wrap_form col mb-3 d-flex flex-column align-items-center'>
                    ...
                    <input type="text" className='input-country col my-3 text-center fs-6 w-100 rounded p-2' placeholder="Ingresa el País (Opcional y en ISO 3166-1 de 2 letras)" maxlength="2" title="El nombre del país es opcional y debe ir en codigo ISO 3166-1" onChange={(e) =>setCountries(e.target.value)} />
